...
================================================  
Rpub : [https://rpubs.com/sohini/723913](https://rpubs.com/sohini/723913)
...
Loading the same seed with the following line of code:
...
The Estimated Accuracy of the Random Forest Model is 71.78% and the Estimated Out-of-Sample Error is 28.22%.  
...
ose <- 1 - as.numeric(confusionMatrix(predictRF, as.factor(validation$classe))$overall[1])
rm(predictRF)
```  
...
pml_write_files = function(x){
  n = length(x)
  for(i in 1:n){
    filename = paste0("Assignment_Solutions_problem_id_",i,".txt")
